...
public class FragmentAticle extends Fragment {
    ...
    private String mSearchword = "";   //Toolbar에서 넘겨 받는 값
    private boolean mRetry = true;

    public FragmentAticle() {

    }

    public static FragmentAticle newInstance(ModelBoard param1) {
        FragmentAticle fragment = new FragmentAticle();
    ...
    private class HttpGetData extends SiteAsyncTask< Integer,  Integer, List<ModelArticle>  > {
        ...
        protected List<ModelArticle> doInBackground(Integer... integers) {
            ...
            List<ModelArticle> result = new HttpBoard().getArticleList(
                    mBoard.getBoardcd() , mSearchword , integers[0] , integers[0] + integers[1] );
