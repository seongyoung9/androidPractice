...
public class FragmentAticleFree extends Fragment {
    ...
    public FragmentAticleFree() {

    }

    public static FragmentAticleFree newInstance(String param1, String param2) {
        FragmentAticleFree fragment = new FragmentAticleFree();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // adapter 생성
        mAdapter = new ArticleAdapter(getContext(), R.layout.listview_customview_article, mData);
